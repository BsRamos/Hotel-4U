					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="./about.php">sobre nós</a></li>
			...
			<div class="row">
				<div class="col">
					...
					<div class="contact_form_container">
						<div class="contact_title text-center">Fale conosco</div>
						<form action="#" id="contact_form" class="contact_form text-center">
							...
							<input type="text" id="contact_form_subject" class="contact_form_subject input_field" placeholder="Título" required="required" data-error="Subject is required.">
							<textarea id="contact_form_message" class="text_field contact_form_message" name="message" rows="4" placeholder="Mensagem" required="required" data-error="Please, write us a message."></textarea>
			...
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<div class="about_content">
						...
						<p class="about_text">Outras plataformas de contato:</p>
					...
					<div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
						<div class="footer_nav">
							<ul class="footer_nav_list">
								...
								<li class="footer_nav_item"><a href="./about.html">Sobre nós</a></li>
								<li class="footer_nav_item"><a href="#">contato</a></li>
							</ul>
						</div>
					</div>
				</div>
