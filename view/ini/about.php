...
<div class="super_container">
					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="./contact.php">contato</a></li>
							</ul>
						</div>
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="/public/images/about_background.jpg"></div>
	...
	<div class="intro">
		<div class="container">
			<div class="row">
				<div class="col-lg-7">
					<div class="intro_image"><img src="/public/images/aboutus1.jpg" alt=""></div>
				</div>
				<div class="col-lg-5">
					<div class="intro_content">
						<div class="intro_title">Sua casa longe de casa</div>
						<p class="intro_text">As incríveis vistas que se pode deslumbrar não é, porém, o único argumento do hotel 4u. Inaugurado em Abril de 2008, com uma decoração de luxo , gerou um grande impacto distinto no mercado global de hospitalidade na última década. Podemos dizer que 4u transformou a maneira como luxo e hospitalidade são definidos. Nós do 4u esforçamos continuamente para atender e exceder suas expectativas.</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="/public/images/milestone_1.png" alt=""></div>
						<div class="milestone_counter" data-end-value="10000">0</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="/public/images/milestone_2.png" alt=""></div>
						<div class="milestone_counter" data-end-value="250">0</div>
						<div class="milestone_text">Passeios Turísticos</div>
					</div>
				</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="/public/images/milestone_3.png" alt=""></div>
						<div class="milestone_counter" data-end-value="33">0</div>
						<div class="milestone_text">Franquias</div>
					</div>
				</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="/public/images/milestone_4.png" alt=""></div>
						<div class="milestone_counter" data-end-value="4000">0</div>
						<div class="milestone_text">Acomodações</div>
					</div>
				</div>
					...
					<div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
						<div class="footer_nav">
							<ul class="footer_nav_list">
								...
								<li class="footer_nav_item"><a href="./contact.php">contato</a></li>
							</ul>
						</div>
					</div>
				</div>
